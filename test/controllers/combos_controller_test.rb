...
class CombosControllerTest < ActionController::TestCase
  ...
  test "should create combo" do
    assert_difference('Combo.count') do
      post :create, combo: { content: @combo.content, name: @combo.name, picture: @combo.picture, price: @combo.price }
    end
  ...
  test "should update combo" do
    patch :update, id: @combo, combo: { content: @combo.content, name: @combo.name, picture: @combo.picture, price: @combo.price }
    assert_redirected_to combo_path(assigns(:combo))
  end
